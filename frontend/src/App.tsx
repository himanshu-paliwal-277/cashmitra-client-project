 ...
 * 1. Router - For routing context (must wrap components using useLocation, useNavigate)
 * 2. AuthProvider - For user authentication
 * 3. CartProvider - For shopping cart state
 * 4. AdminAuthProvider - For admin authentication
 * 5. PartnerAuthProvider - For partner authentication
 * 6. AgentAuthProvider - For agent authentication
 */
function App() {
  return (
    <ErrorBoundary>
