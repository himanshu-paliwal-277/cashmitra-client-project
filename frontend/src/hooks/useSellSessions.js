...
const useSellSessions = () => {
  ...
  const updateSessionAnswers = useCallback(async (sessionId, answersData) => {
    setLoading(true);
    setError(null);
    try {
      const token = localStorage.getItem('token');
  ...
  const updateSessionDefects = useCallback(async (sessionId, defectsData) => {
    setLoading(true);
    setError(null);
    try {
      const token = localStorage.getItem('token');
  ...
  const updateSessionAccessories = useCallback(async (sessionId, accessoriesData) => {
    setLoading(true);
    setError(null);
    try {
      const token = localStorage.getItem('token');
