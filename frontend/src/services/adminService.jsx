...
class AdminService {
  ...
  async toggleBuyProductStatus(id) {
  ...
  async verifyPartner(partnerId, verificationData) {
    try {
  ...
  async getOrderPickupDetails(orderId) {
    try {
  ...
  async getBuyOrderPickupDetails(orderId) {
    try {
  ...
  async createSellSuperCategory(data) {
    try {
  ...
  async updateSellSuperCategory(id, data) {
    try {
  ...
  async deleteSellSuperCategory(id) {
    try {
  ...
  async createBuySuperCategory(data) {
    try {
  ...
  async updateBuySuperCategory(id, data) {
    try {
  ...
  async deleteBuySuperCategory(id) {
    try {
  ...
  async updateInventoryApprovalStatus(approvalId, status, notes = '') {
    try {
  ...
  async createConditionQuestionnaire(questionnaireData) {
    try {
  ...
  async getBuyCategoryById(categoryId) {
    try {
  ...
  async createBuyCategory(categoryData) {
    try {
  ...
  async updateBuyCategory(categoryId, categoryData) {
    try {
  ...
  async deleteBuyCategory(categoryId) {
    try {
  ...
  async updateConditionQuestionnaire(questionnaireId, questionnaireData) {
    try {
