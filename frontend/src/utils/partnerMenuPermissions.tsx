 ...
 */
export const hasMenuPermission = (permissions: any, permissionName: any) => {
 ...
 */
export const isMenuItemReadOnly = (permissions: any, permissionName: any) => {
  if (!permissions || !permissions[permissionName]) {
 ...
 */
export const getMenuPermissionDetails = (permissions: any, permissionName: any) => {
 ...
 */
export const filterMenuItemsByPermissions = (menuItems: any, permissions: any) => {
 ...
 */
export const getAvailableMenuItems = (permissions: any) => {
 ...
 */
export const hasTimeRestrictions = (permissions: any, permissionName: any) => {
 ...
 */
export const hasDateRestrictions = (permissions: any, permissionName: any) => {
  const permission = getMenuPermissionDetails(permissions, permissionName);
 ...
 */
export const isMenuItemAccessible = (permissions: any, permissionName: any) => {
 ...
 */
export const canPerformAction = (businessLimits: any, action: any, currentCount = 0) => {
