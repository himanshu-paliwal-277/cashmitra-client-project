...
import { Package, Smartphone, Tablet, Laptop, Watch, Headphones } from 'lucide-react';
...
const BuySuperCategorySelection = () => {
  ...
  const fetchSuperCategories = async () => {
    try {
      ...
      console.error('Error fetching buy super categories:', err);
  ...
  const handleSuperCategoryClick = (superCategory: any) => {
    // Navigate to categories page for this super category
    navigate(`/buy/category/${encodeURIComponent(superCategory.name)}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 text-white py-12 sm:py-16 px-4 relative overflow-hidden">
        ...
        <div className="main-container text-center relative">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-white">
            Buy Refurbished Devices
          </h1>
          <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto">
            Discover quality pre-owned devices at unbeatable prices. All devices come with warranty
      ...
      <div className="main-container">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 bg-white rounded-2xl shadow-2xl p-6 sm:p-8 -mt-8 relative z-20 border border-slate-200">
          <div className="flex items-center gap-3 p-2">
            ...
            <p className="text-sm sm:text-base font-semibold text-slate-900">Quality Assured</p>
          </div>
          ...
          <div className="flex items-center gap-3 p-2">
            ...
            <p className="text-sm sm:text-base font-semibold text-slate-900">Free Delivery</p>
          </div>
          ...
          <div className="flex items-center gap-3 p-2">
            ...
            <p className="text-sm sm:text-base font-semibold text-slate-900">Best Prices</p>
          </div>
          ...
          <div className="flex items-center gap-3 p-2">
            ...
            <p className="text-sm sm:text-base font-semibold text-slate-900">12M Warranty</p>
          </div>
        </div>
        ...
        <div className="text-center my-12 sm:my-16">
          ...
          <p className="text-lg text-slate-600">Choose a category to explore our products</p>
        </div>
...
export default BuySuperCategorySelection;
