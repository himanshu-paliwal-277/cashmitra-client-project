...
const WalletRecharge: React.FC = () => {
  ...
  const fetchBankConfig = async () => {
    try {
      const response = await partnerService.getBankConfig();
  ...
  const fetchRechargeHistory = async () => {
    try {
      setLoading(true);
      const response = await partnerService.getRechargeRequests();
  ...
  const handleSubmitRequest = async (e: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      await partnerService.createRechargeRequest({
      ...
      fetchRechargeHistory();
      // Refresh wallet balance in case it was updated
      refreshBalance();
    ...
    <div className=" ">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Add funds to your wallet by making a bank transfer and uploading payment proof
        </p>
      </div>
      ...
      {activeTab === 'recharge' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            {bankConfig ? (
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-sm text-amber-800">
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>Upload the screenshot and submit your request</li>
                        <li>Your wallet will be credited after admin approval</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Bank details not configured. Please contact admin.</p>
              </div>
            )}
          </div>
          ...
          {/* Recharge Form */}
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <h2 className="text-xl font-semibold mb-4">Submit Recharge Request</h2>
            ...
            <form onSubmit={handleSubmitRequest} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={submitting || uploadingImage || !bankConfig}
      ...
      {activeTab === 'history' && (
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            <h2 className="text-xl font-semibold">Recharge Request History</h2>
          </div>
