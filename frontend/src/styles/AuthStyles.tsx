...
export const Input = styled.input`
  ...
  border: 2px solid ${(props: any) => props.hasError ? theme.colors.error.main : theme.colors.grey[300]};
  ...
  &:focus {
    outline: none;
    border-color: ${(props: any) => props.hasError ? theme.colors.error.main : theme.colors.primary.main};
...
export const Button = styled.button`
  padding: ${theme.spacing[3]} ${theme.spacing[4]};
  background: ${(props: any) => props.disabled
