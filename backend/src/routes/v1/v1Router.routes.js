...
import commissionRequestRoutes from './commissionRequest.routes.js';
import commissionSettingsRoutes from './commissionSettings.routes.js';
...
router.use('/commission-requests', commissionRequestRoutes);
