...
const ReturnsTableOfContents = () => {
  ...
  const sections = [
    ...
    { id: 'refund-methods', title: 'Refund Methods' },
    { id: 'partial-refunds', title: 'Partial Refunds' },
    { id: 'replacement', title: 'Replacement Policy' },
    { id: 'defective-products', title: 'Defective Products' },
    { id: 'seller-devices', title: 'Sold Devices' },
...
export default ReturnsTableOfContents;
