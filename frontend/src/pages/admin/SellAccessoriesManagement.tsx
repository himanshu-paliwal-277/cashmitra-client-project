...
const SellAccessoriesManagement = () => {
  ...
  const getAccessoryIcon = (category: any) => {
        ...
        <Card.Footer divider className="bg-gray-50">
          <div className="flex justify-between items-center">
            <div className="flex gap-2">
              <button
                onClick={() => console.log('View accessory:', accessory._id)}
            ...
            <div className="flex gap-1">
              <button
                onClick={() => console.log('Move up:', accessory._id)}
                className="p-1.5 border border-gray-300 rounded bg-white hover:bg-gray-50 hover:border-amber-500 hover:text-amber-600 transition-colors"
                title="Move Up"
              >
                <ArrowUp size={14} />
              </button>
              <button
                onClick={() => console.log('Move down:', accessory._id)}
                className="p-1.5 border border-gray-300 rounded bg-white hover:bg-gray-50 hover:border-amber-500 hover:text-amber-600 transition-colors"
                title="Move Down"
              >
                <ArrowDown size={14} />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all min-h-[100px] resize-y"
                  />
                </div>
