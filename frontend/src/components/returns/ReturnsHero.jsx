import { RefreshCw, ShieldCheck, Clock, FileText } from 'lucide-react';

const ReturnsHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-accent-50 py-12">
      {/* Animated Background */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-grey-600 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
            Your satisfaction is our priority. Learn about our easy return and refund process.
          </p>
