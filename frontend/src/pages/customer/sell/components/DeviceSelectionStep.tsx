      ...
      <div className="mb-8">
        ...
        {brandsLoading || categoriesLoading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {getMobileBrands().map((brand: any) => <div
      ...
      {formData.brand && (
        <div className="mb-8">
          ...
          >
            ...
            {getModelsByBrand(formData.brand).map((model: any) => <option key={model._id || model.id} value={model.name}>
              {model.name}
            </option>)}
          </select>
        </div>
        ...
        <>
          <div className="mb-8">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-3">
              {storageOptions.map((storage: any) => <div
                key={storage}
          ...
          <div className="mb-8">
            ...
            >
              ...
              {colorOptions.map((color: any) => <option key={color} value={color}>
                {color}
              </option>)}
            </select>
          </div>
