...
export var MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/cashify';

export var MONGO_URI = process.env.MONGO_URI ||
...
export var JWT_EXPIRY = process.env.JWT_EXPIRY || process.env.JWT_EXPIRES_IN || '7d';
...
export var EMAIL_PASSWORD = process.env.EMAIL_PASSWORD || process.env.EMAIL_PASS;
...
export var ENABLE_EMAIL_VERIFICATION = process.env.ENABLE_EMAIL_VERIFICATION === 'true' || false;
