...
export const laptopProducts = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 124,
    image: 'https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/xps-notebooks/xps-15-9530/media-gallery/notebook-xps-15-9530-nt-silver-gallery-1.psd?fmt=pjpg&pscan=auto&scl=1&wid=3491&hei=2681&qlt=100,1&resMode=sharp2&size=3491,2681&chrss=full&imwidth=5000',
    images: [
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 76,
    image: 'https://p3-ofp.static.pub/ShareResource/na/subseries/hero/lenovo-thinkpad-x1-carbon-gen-11-14-intel-hero.png',
    images: [
...
export const getProductsByBrand = (brand, category = null) => {
...
export const sortProducts = (products, sortBy) => {
  ...
  switch (sortBy) {
    ...
    case 'newest':
      return sorted.sort((a, b) => new Date(b.createdAt || '2024-01-01') - new Date(a.createdAt || '2024-01-01'));
    case 'popularity':
    default:
  ...
  faqs: [
    {
      ...
      answer: 'Simply select your device category, choose your brand and model, answer a few questions about its condition, and get an instant quote. If you accept, we\'ll arrange free pickup from your location.',
      category: 'selling'
    },
    {
      id: 'faq-002',
      question: 'What is the return policy?',
      answer: 'We offer a 7-day return policy for all purchases. If you\'re not satisfied with your device, you can return it within 7 days for a full refund.',
      category: 'buying'
    },
    {
      id: 'faq-003',
      question: 'How is the device condition determined?',
      answer: 'Our experts perform a comprehensive 32-point inspection covering physical condition, functionality, battery health, and performance to ensure accurate grading.',
      category: 'quality'
    },
    {
      id: 'faq-004',
      question: 'What payment methods do you accept?',
      answer: 'We accept all major credit/debit cards, UPI, net banking, and digital wallets. For selling, we offer instant bank transfer or cash on pickup.',
      category: 'payment'
    },
    {
      id: 'faq-005',
      question: 'Is my data safe when I sell my device?',
      answer: 'Yes, we ensure complete data security. Our certified technicians perform secure data wiping using industry-standard methods to protect your privacy.',
      category: 'security'
    },
    {
      id: 'faq-006',
      question: 'Do you provide warranty on refurbished devices?',
      answer: 'Yes, all our certified refurbished devices come with a 12-month warranty covering hardware defects and functionality issues.',
      category: 'warranty'
    }
  ],
  contactInfo: {
