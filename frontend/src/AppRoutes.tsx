...
const PartnerCommissionPayment = lazy(() => import('./pages/partner/CommissionPayment'));
...
const WalletRequests = lazy(() => import('./pages/admin/WalletRequests'));
    ...
    <Routes>
      ...
      <Route path="/partner" element={<PartnerProtectedRoute />}>
        <Route element={<PartnerLayout />}>
          ...
          <Route path="commission-payment" element={<PartnerCommissionPayment />} />
