...
const CreateProductModal: React.FC<CreateProductModalProps> = ({ isOpen, onClose, onSuccess }) => {
      ...
      setFormData((prev: any) => {
        ...
        if (name === 'pricing.mrp' || name === 'pricing.discountedPrice') {
          ...
          if (mrp > 0 && discountedPrice > 0 && discountedPrice < mrp) {
            ...
            // If discounted price is greater than or equal to MRP, set discount to 0
            newData.pricing.discountPercent = '0';
          } else if (discountedPrice === 0 || val === '') {
            // If discounted price is cleared, reset discount percentage
  ...
  const isFormValid = () => {
    return (
      ...
      formData.pricing.mrp &&
      parseFloat(formData.pricing.mrp) > 0 &&
    ...
    try {
      ...
      const productData = {
        ...
        availability: {
          ...
          quantity: parseInt(formData.stock.quantity) || 0, // Use stock quantity for availability
        },
      };
                    ...
                    <button
                      ...
                      onClick={() =>
                        setFormData((prev: any) => ({
                          ...
                          variants: [
                            ...prev.variants,
                            { storage: '', color: '', price: 0, stock: true },
                          ],
                        }))
                      }
                      className="flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200"
