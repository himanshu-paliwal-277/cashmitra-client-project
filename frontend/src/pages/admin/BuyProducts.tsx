...
const ActionButton = styled.button`
  background: ${(props: any) => props.variant === 'primary' ? 'linear-gradient(135deg, #10b981 0%, #059669 100%)' : '#f3f4f6'};
  color: ${(props: any) => props.variant === 'primary' ? 'white' : '#374151'};
  border: ${(props: any) => props.variant === 'primary' ? 'none' : '1px solid #d1d5db'};
  ...
  &:hover {
    ...
    box-shadow: ${(props: any) => props.variant === 'primary'
...
const StatIcon = styled.div`
  ...
  height: 3rem;
  border-radius: 0.75rem;
  background: ${(props: any) => props.color || '#10b981'};
  color: white;
  display: flex;
  align-items: center;
...
const ViewButton = styled.button`
  padding: 0.75rem;
  border: none;
  background: ${(props: any) => props.active ? '#10b981' : 'white'};
  color: ${(props: any) => props.active ? 'white' : '#6b7280'};
  cursor: pointer;
  transition: all 0.2s;

  &:hover {
    background: ${(props: any) => props.active ? '#059669' : '#f9fafb'};
  }
`;
    ...
    <Container>
      ...
      <FiltersSection>
        <FiltersRow>
          ...
          <FilterSelect value={selectedStatus} onChange={(e: any) => setSelectedStatus(e.target.value)}>
