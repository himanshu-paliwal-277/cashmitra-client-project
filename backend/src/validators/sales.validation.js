...
export const createOrderSchema = {
  body: z.object({
    items: z.union([
      z.array(z.object({
        inventoryId: z.string().regex(/^[0-9a-fA-F]{24}$/, 'Valid inventory ID is required'),
...
export const updateShippingSchema = {
  body: z.object({
    ...
    estimatedDelivery: z.coerce.date({ invalid_type_error: 'Estimated delivery must be a valid date' }).optional(),
  }),
};
