...
import { getBuyCategories } from '../../services/productService';
...
const Marketplace = () => {
  ...
  const renderProduct = (product) => {
    ...
    const productImage = product.images?.[0] || 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=300&fit=crop';
    ...
    return (
      ...
      >
        <div className="marketplace-product-image">
          ...
          {product.condition && (
            <span className="marketplace-product-badge">{product.condition}</span>
          )}
          <button
        ...
        <div className="marketplace-product-info">
          ...
          <p className="marketplace-product-specs">
            {product.variant?.ram && `${product.variant.ram}`}
