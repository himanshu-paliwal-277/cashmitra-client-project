...
const useSellProducts = () => {
  ...
  const updateProduct = useCallback(
    async (productId: any, productData: any) => {
      setLoading(true);
      setError(null);
      try {
        const token = localStorage.getItem('adminToken');
  ...
  const fetchVariants = useCallback(async (productId: any) => {
    setLoading(true);
    setError(null);
    try {
      const token = localStorage.getItem('adminToken');
  ...
  const createVariant = useCallback(
    async (productId: any, variantData: any) => {
      setLoading(true);
      setError(null);
      try {
        const token = localStorage.getItem('adminToken');
  ...
  const updateVariant = useCallback(
    async (productId: any, variantId: any, variantData: any) => {
      setLoading(true);
      setError(null);
      try {
        const token = localStorage.getItem('adminToken');
  ...
  const deleteVariant = useCallback(
    async (productId: any, variantId: any) => {
      setLoading(true);
      setError(null);
      try {
        const token = localStorage.getItem('adminToken');
  ...
  const getPublicProduct = useCallback(async (productId: any) => {
    setLoading(true);
    setError(null);
    try {
