...
const AddBuyProductNew = () => {
  ...
  // Show disabled message for admin product creation
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Product Creation Disabled</h1>
        <p className="text-gray-600 mb-6">
          Product creation is now handled exclusively by partners. Admins can only manage categories
          and view existing products.
        </p>
        <div className="space-y-3">
          ...
          <button
            onClick={() => navigate('/admin/buy-categories')}
...
const AddBuyProductNewDisabled = () => {
  const navigate = useNavigate();
