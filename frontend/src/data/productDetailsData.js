    ...
    skus: {
      '4gb-64gb-blue': {
        ...
        thumbnails: [
          {
            type: 'image',
            url: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=100&h=100&fit=crop',
          },
          {
            type: 'image',
            url: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=100&h=100&fit=crop',
          },
          {
            type: 'image',
            url: 'https://images.unsplash.com/photo-1565849904461-04a58ad377e0?w=100&h=100&fit=crop',
          },
          {
            type: 'image',
            url: 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=100&h=100&fit=crop',
          },
          {
            type: '360',
            url: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=100&h=100&fit=crop',
            badge: '360°',
          },
        ],
      },
      '6gb-128gb-blue': {
        ...
        thumbnails: [
          ...
          {
            type: 'video',
            url: 'https://images.unsplash.com/photo-1607936854279-55e8f4bc0b9a?w=100&h=100&fit=crop',
            badge: 'Video',
          },
        ],
      },
      '6gb-256gb-blue': {
        ...
        thumbnails: [
          ...
          {
            type: 'image',
            url: 'https://images.unsplash.com/photo-1605236453806-b25e5d5cce04?w=100&h=100&fit=crop',
          },
        ],
      },
      ...
      list: [
        {
          ...
          content:
            "Bought this iPhone 12 and I'm extremely satisfied. The condition is exactly as described - looks and feels like a brand new phone. Battery life is great, camera quality is superb. Delivery was quick and packaging was secure.",
          pros: [
            'Excellent condition',
            'Fast delivery',
            'Great battery life',
        ...
        },
        {
          ...
          content:
            "Overall a good purchase. The phone works perfectly and all features are functional. There are some very minor scratches on the back which are barely visible. For the price, it's a great deal.",
        ...
        },
        {
          ...
          content:
            'Needed a reliable phone for daily use and this fits perfectly. The 64GB storage is sufficient for my usage. Phone is in very good condition with minimal signs of use. Highly recommended for anyone looking for a budget-friendly iPhone.',
        ...
        },
        {
          ...
          content:
            'The camera quality is amazing! Photos come out crisp and clear. The phone is in excellent condition as advertised. Only minor complaint is that the battery drains a bit faster than expected, but overall very satisfied.',
        ...
        },
        {
          ...
          content:
            'Phone works fine for basic usage but I noticed some lag while multitasking. The condition is as described - good but with visible signs of use. Customer service was helpful when I had questions.',
        ...
        },
        {
          ...
          content:
            'This phone exceeded my expectations in every way. The condition is pristine, almost like new. The 256GB storage is perfect for all my apps and photos. The seller was very professional and the phone arrived exactly as described.',
      ...
      list: [
        {
          ...
          answer: {
            content:
              'The battery health is 95% as mentioned in the product description. All our devices undergo thorough battery testing before listing.',
        ...
        },
        {
          ...
          answer: {
            content:
              'Yes, we include a Lightning cable and power adapter with every iPhone. However, the original Apple charger may not be included - we provide a compatible charger that works perfectly.',
            answeredBy: 'TechHub Store',
        ...
        },
        {
          ...
          answer: {
            content:
              'Absolutely! We offer a 7-day no-questions-asked return policy. The phone should be in the same condition as received for a full refund.',
            answeredBy: 'TechHub Store',
        ...
        },
        {
          ...
          answer: {
            content:
              'Yes, this iPhone 12 is factory unlocked and will work with all major carriers in India including Jio, Airtel, Vi, and BSNL.',
            answeredBy: 'TechHub Store',
        ...
        },
        {
          ...
          answer: {
            content:
              'We provide a 12-month seller warranty covering manufacturing defects and hardware issues. Physical damage and water damage are not covered.',
            answeredBy: 'TechHub Store',
        ...
        },
        {
          ...
          answer: {
            content:
              'Delivery typically takes 2-3 business days for most locations. We use secure packaging to ensure your device arrives safely.',
            answeredBy: 'TechHub Store',
