  ...
  return (
    ...
    >
      <div className="banner-wrapper">
        <div className="banner-slides" style={{ transform: `translateX(-${currentSlide * 25}%)` }}>
        ...
        <button className="banner-nav banner-nav-next" onClick={goToNext} aria-label="Next slide">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              d="M9 18L15 12L9 6"
              stroke="currentColor"
