...
const IconButton = styled.button`
  background: ${(props: any) => props.primary ? '#3b82f6' : props.danger ? '#ef4444' : props.success ? '#10b981' : '#6b7280'};
  color: white;
  border: none;
  padding: 0.5rem;
  ...
  return (
    <Container>
      ...
      <FilterSection>
        ...
        <FilterSelect value={brandFilter} onChange={(e: any) => setBrandFilter(e.target.value)}>
                    ...
                    >
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e: any) => handleVariantChange(index, 'storage', e.target.value)}
